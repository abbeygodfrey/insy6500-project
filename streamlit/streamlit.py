...
#from functions import load_data, create_corr
...
This project strengthens skill sets pertaining to data exploration, cleaning, and analysis. The “real world” data set selected for this project is the “Digital 
